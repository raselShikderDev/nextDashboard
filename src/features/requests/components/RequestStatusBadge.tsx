...
interface RequestStatusBadgeProps { status: RequestStatus; className?: string; }
...
const statusConfig: Record<RequestStatus, { label: string; className: string }> = {
  ...
  approved: { label: "Approved", className: "bg-blue-100 text-blue-800 dark:bg-blue-900/30 dark:text-blue-400 border-blue-200" },
